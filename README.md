...
[![Install Learn MCP Server in Visual Studio](https://img.shields.io/badge/Install%20in%20Visual%20Studio-blue?logo=visualstudio)](vsweb+mcp:/install?{"name":"microsoft.docs.mcp","type":"http","url":"https://learn.microsoft.com/api/mcp"})
...
| **Visual Studio** | [![Install Learn MCP Server in Visual Studio](https://img.shields.io/badge/Install%20in%20Visual%20Studio-blue?logo=visualstudio)](vsweb+mcp:/install?{"name":"microsoft.docs.mcp","type":"http","url":"https://learn.microsoft.com/api/mcp"}) | [Visual Studio MCP Official Guide](https://learn.microsoft.com/en-us/visualstudio/ide/mcp-servers?view=vs-2022) |
